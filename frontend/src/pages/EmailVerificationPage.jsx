    ...
    return (
        ...
        >
            <motion.div
                ...
                className=" bg-slate-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl
         shadow-2xl p-8 w-full max-w-md"
            >
              ...
              text-transparent bg-clip-text">Verify Your Email</h2>
                    ...
                    <div className="flex justify-between">
                        {
                            code.map((digit, index) => (
                                <input
                                    ...
                                    className="w-12 h-12 text-center text-2xl font-bold bg-gray-700 bg-opacity-50 rounded-lg border-2 border-gray-700
                                    focus:border-green-500 text-white focus:outline-none"
                                />
                            ))
                        }
                    </div>
